...
namespace test {
	...
	TestTexture2D::TestTexture2D()
		: m_Proj(glm::ortho(0.f, 960.f, 0.f, 540.f, -1.f, 1.f)), m_View(glm::translate(glm::mat4(1.f), glm::vec3(0.f, 0.f, 0.f))), m_TranslationA(200.f, 200.f, 0.f), m_TranslationB(400.f, 200.f, 0.f)
	{
		float positions[] = {
